        ...
        @if($this->form->schedule_id === 'new')
            <div>
                ...
                <x-text-input
                    ...
                    required
                    autofocus
                    x-init="$el.addEventListener('focus', function() { this.showPicker?.(); })"
                />
        ...
        <div class="md:col-span-2">
            ...
            @if($this->editing)
                ...
                <x-select-input
                    ...
                    id="day_ids"
                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-sm focus:border-yellow-500 focus:ring-yellow-500 text-sm"
                    required
                >
            ...
            @else
                ...
                <div class="mt-2 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md p-3 shadow-sm max-h-48 overflow-y-auto space-y-2">
                    @foreach($this->allDays as $day)
                        <label
